...
namespace TechProgram2025.Migrations
{
    ...
    [Migration("20250403155014_Init_DB")]
            ...
            modelBuilder.Entity("TechProgram2025.Models.InsuranceVariant", b =>
                {
                    ...
                    b.Property<int>("CategoryInsuranceCategoryID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoryInsuranceCategoryID");
            ...
            modelBuilder.Entity("TechProgram2025.Models.InsuranceVariant", b =>
                {
                    b.HasOne("TechProgram2025.Models.InsuranceCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryInsuranceCategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
